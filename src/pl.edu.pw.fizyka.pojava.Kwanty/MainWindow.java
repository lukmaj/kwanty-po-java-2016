...
//					System.out.println("x " + newCenterX + " y " + newCenterY);
		...
		this.addKeyListener(new KeyListener()
		{
			...
			public void keyPressed(KeyEvent arg0)
			{
				...
				// DOES NOT STEER SHIP AFTER REPLACEMENT
				
				if (keyPressed == KeyEvent.VK_LEFT)
				{
					playerShip.engineAcceleration(playerShip.getEngineAccelerationX() - 0.5, playerShip.getEngineAccelerationY());
				}
				...
				{
					playerShip.engineAcceleration(playerShip.getEngineAccelerationX(), playerShip.getEngineAccelerationY() - 0.5);
				}
...
//				if (illustrate.refresh)
		...
		startSim.addActionListener(new ActionListener()
		{
			...
			{
				illustrate.startTimer(playerShip);
				startSim.setEnabled(false);
				stopSim.setEnabled(true);
			}
		});
